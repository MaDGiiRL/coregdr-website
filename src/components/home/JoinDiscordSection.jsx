...
export default function JoinDiscordSection() {
  return (
    <section
      id="join-discord"
      className="rounded-3xl border border-[var(--color-border)] bg-gradient-to-r from-[#181a33]/90 via-[#15162c]/90 to-[#181a33]/90 p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-8 shadow-xl overflow-hidden relative"
    >
      {/* glow dietro */}
      ...
      <div className="relative z-10 max-w-xl space-y-3">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 mt-3">
          <a
            href="https://discord.gg/tuo-invite" // <-- metti il tuo link
            target="_blank"
            rel="noreferrer"
      ...
      {/* Parte 3D con logo */}
      <div className="relative z-10 w-full md:w-1/2 h-56 md:h-64 lg:h-72 rounded-3xl border border-white/10 bg-black/40 overflow-hidden">
